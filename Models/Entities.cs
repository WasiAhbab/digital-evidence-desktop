...
namespace TraceLock.Desktop.Models;
...
public static class Roles
{
    ...
    public static readonly string[] All = [Administrator, Investigator, Analyst, Custodian, Auditor];
}
...
public sealed class AuditLog
{
    ...
    [StringLength(80)] public string IpAddress { get; set; } = "Local desktop";
